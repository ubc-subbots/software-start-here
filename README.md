...
* [Windows Subsystem for Linux (WSL) 2](https://docs.microsoft.com/en-us/windows/wsl/install-win10)
  ...
  * If you've installed Windows build 21364 or higher (check using the program, winver), you will be able to run GUI application automatically, if you have not, continue with the next instruction
